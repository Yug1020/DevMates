...
export const feed = async(req, res) => {
    ...
    try {
        ...
        const query = {$and:[{$or:[{fromRequest:loggedInUser}, {toRequest:loggedInUser}]}, {$or:[{sentStatus: "connect"}, {sentStatus: "pass"}, {sentStatus: "ignored"}]}, {$or:[{receivedStatus: "accept"}, {receivedStatus: "rejected"}, {receivedStatus: "pending"}]}]}
