...
export const profile = async(req, res) => {
    try{
        ...
        const filteredUserInfo = { firstName:userData.firstName, lastName:userData.lastName, streetName:userData.streetName,email:userData.email, gender:userData.gender, age:userData.age, phone:userData.phone, photoURL:userData.photoURL, skills:userData.skills, profession: userData.profession, goal: userData.goal, isPremium: userData.isPremium }       
